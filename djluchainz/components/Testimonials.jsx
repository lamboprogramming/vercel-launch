              ...
              <div className="items-start -mx-3 capitalize md:flex">
                    ...
                    {/* Card */}
                      <div className="w-full p-5 mx-auto mb-6 font-light text-black bg-white border border-gray-200 rounded-lg">
                          ...
                          <div className="w-full">
                              <p className="text-lg leading-10">The kids start to go wild when they know a party is coming up and the dj is going to be in town ! </p>
                          </div>
                      </div>
                    {/* Card */}
                      <div className="w-full p-5 mx-auto mb-6 font-light text-black bg-white border border-gray-200 rounded-lg">
                          ...
                          <div className="w-full">
                              <p className="text-lg leading-10"> I never thought working out and music went together but this feels like a kickboxing party - I get so hyped up. Whoever had an idea for a DJ at the gym is a genius </p>
                          </div>
                      </div>
                  </div>
                    {/* Card */}
                  <div className="px-3 md:w-1/3">
                      <div className="w-full p-5 mx-auto mb-6 font-light text-black bg-white border border-gray-200 rounded-lg">
                          ...
                          <div className="w-full">
                              <p className="text-lg leading-10"> I was supposed to leave hours ago but every song has me in a chokehold. Please tell me you have business card and you will be free this summer because I need you for all of my parties 😩</p>
                          </div>
                      </div>
                      {/* Card */}
                      <div className="w-full p-5 mx-auto mb-6 font-light bg-white border border-gray-200 rounded-lg black">
                          ...
                          <div className="w-full">
                              <p className="text-lg leading-10 text-black xl ">  Clearly you have been doing this for awhile, right? Because you have what some would call an old soul & a really good ear for music </p>
                          </div>
                      </div>
                  </div>
