...
const Social = () => {
  return (
  <div className='flex items-center justify-between px-6 py-2 m-8 mt-4 overflow-hidden sm:justify-evenly sm:m-8 rounded-3xl bg-gradient-to-r from-fuchsia-700 to-indigo-500 hover:from-indigo-500 hover:to-fuchsia-500'>
       {/* SOUNDCLOUD */}
    <div>
    <a
