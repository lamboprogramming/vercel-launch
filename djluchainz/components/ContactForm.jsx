...
const ContactForm = () => {
  ...
  <section className="mb-6 text-center ">
    <div className="max-w-md px-3 py-6 mx-auto shadow-xl lg:px-6 ">
      ...
      {/* Date */}
        <div className="mb-6 ">
          <input type="date" placeholder='MM-DD-YYYY' className="w-full px-3 py-4 leading-tight text-gray-400 uppercase bg-white border rounded shadow appearance-none md:py-2 focus:outline-none focus:bg-white focus:border-blue-600" name="date" />
        </div>
      {/* Category */}
        <div className="mb-6 ">
